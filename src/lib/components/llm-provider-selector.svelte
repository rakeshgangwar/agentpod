<script lang="ts">
   ...
   * to select a model for their project. Unconfigured providers are shown
   * but disabled until credentials are added.
   */
  ...
  async function loadProviders() {
    ...
    try {
      providers = await listProvidersWithModels(!showAllProviders);
