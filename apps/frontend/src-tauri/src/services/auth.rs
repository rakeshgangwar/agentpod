...
// that may reference them. They will be removed in a future version.

#[derive(Debug, Clone, Serialize, Deserialize)]
#[deprecated(note = "Use SessionData instead")]
pub struct AuthData {
    ...
    pub user_info: Option<LegacyUserInfo>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
#[deprecated(note = "Use UserInfo instead")]
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[deprecated(note = "Use default API URL from config instead")]
