...
async function main() {
  console.log("🤖 OpenCode Agent Generator")
  console.log("=" .repeat(50))
  console.log()
  
  await mkdir(OUTPUT_DIR, { recursive: true })
  
  console.log("📝 Converting agents to OpenCode format:")
  console.log()
  ...
  for (const agent of ALL_AGENTS) {
    ...
    console.log(`   ${agent.emoji || "🤖"} ${agent.name.padEnd(10)} ${agent.role.padEnd(25)} [${perms}] (${lines} lines)`)
  }
  ...
  console.log()
  console.log("=" .repeat(50))
  console.log(`✅ Generated ${agentDefinitions.length} agent definitions`)
