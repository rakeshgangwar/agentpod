...
// =============================================================================
// GET /resource-tiers/:id/limits
// =============================================================================
// Get Docker resource limits for Coolify
resourceTiersRouter.get('/:id/limits', (c) => {
  const tierId = c.req.param('id');
  log.info('Getting resource limits for tier', { tierId });
  ...
  try {
    ...
    const limits = getResourceLimitsForTier(tier);
    ...
    log.error('Failed to get resource limits', { tierId, error });
    return c.json({ error: 'Failed to get resource limits' }, 500);
  }
});
